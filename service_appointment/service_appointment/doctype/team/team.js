					...
					if (values) {
						...
						function check_overlap_or_add_slot(week_day, cur_time, end_time, add_slots_to_child) {
							...
							while (cur_time < end_time) {
								...
								if (to_time <= end_time) {
									if (frm.doc.time_working_schedule) {
										frm.doc.time_working_schedule.forEach(function (slot) {
									...
									if (add_to_child && add_slots_to_child) {
										frm.add_child('time_working_schedule', {
						...
						frm.refresh_field('time_working_schedule');
